...
<div class="content-area contact-template pp-dark-blue-bg min-height-100vh flex ">
    ...
    <div class="starter-div flex justify-between center general-container margin-auto">
      ...
      <div class="form-intro w-30 flex flex-column justify-between">
        <div>
          <h1 class="white">Thank you for reaching out</h1>
        ...
        <div>
          <div class="london-off">
           ...
           London, United Kingdom</p>
					...
					<p class="white"><a href="#" class="white">info@prohibitionpartners.com</a><br>+44 020 7409 5042</p>
        </div>
      </div>
      
        <div class="form-container flex flex-column center w-60 bg-white pa5 pp-corners">
          <h1 class="pp-dark-blue f2">We've received your message succesfully and will get back to you shortly. In the meantime, we invite you to<br><a href="reports" class="platform ttu tu f3">Download our reports</a></h1>
        </div>
                ...
                <div class="pa4" >
                  ...
                  <div class="flex flex-row no-wrap items-center ">
                    ...
                    <?php if ( get_field('mail_adress') ): ?>
                      <a href="mailto:<?php the_field('mail_adress'); ?>">
